...
Math
--------------
The two main mathematical files are [markov_calculator.py](https://github.com/vsharm/markovbaseball-webapp/blob/master/markovbaseball/ccba/markov_calculator.py) which does the raw markov chain calculation to find the run distribution  and [analysis.py](https://github.com/vsharm/markovbaseball-webapp/blob/master/markovbaseball/ccba/analysis.py) which does all of the analysis based on the run distribution generated by the [markov_calculator.py](https://github.com/vsharm/markovbaseball-webapp/blob/master/markovbaseball/ccba/markov_calculator.py).
